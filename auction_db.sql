...
CREATE TABLE lotter(
  LotterID                     INT             PRIMARY KEY  AUTO_INCREMENT,
...
CREATE TABLE image(
  ...
  PictureUrl 					VARCHAR(10)		not null,
...
CREATE TABLE  Item(
  ...
  CONSTRAINT req_ltr unique (LotterID, AuctionID)
);

 
-- insert lotter
INSERT INTO 'lotter' (LotterID, Name,) VALUES 
(41,'Daniel'),
(42,'Sherry'),
(43,'Cody'),
(44,'Evan'),
...
-- insert auction
INSERT INTO 'auction' (ID, Title, StartDateTime, EndDateTime) 
VALUES 
...
-- insert image
INSERT INTO 'image' (PictureID, PictureUrl, Item) 
VALUES 
...
-- insert auction
INSERT INTO 'Item' (ItemID, ItemBrand, ItemDescription, MSRP, Model, LoadNumber, LotterID, AuctionID) 
VALUES 
